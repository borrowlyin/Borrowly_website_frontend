...
/>
      ...
      <div className="mt-5">
        <EmiCalculator options={false} title="📊 Education Loan Calculator" subtitle="Find the right education loan plan with ease.
Borrowly’s Education Loan Calculator helps you estimate your EMIs, interest costs, and total repayment in just seconds—so you can plan your studies without financial stress." />
      </div>
