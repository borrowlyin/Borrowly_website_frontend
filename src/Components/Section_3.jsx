...
const Section_3 = ({ isDarkMode }) => {
  ...
  return (
    <div ref={sectionRef} className="md:h-[100dvh] flex items-center">
      <div className="container mx-auto flex flex-col lg:flex-row items-center gap-5">
        ...
        <div className="flex-1 px-5 md:px-10 lg:px-0">
          ...
          <div className={`flex items-center gap-1 mt-3 w-fit px-3 py-1.5 rounded-xl ${isDarkMode?'bg-white':'bg-white'} border border-[#D7D7D7]`}>
            ...
            <p
              style={{ fontFamily: 'PovetaracSansBold' }}
              className="text-[#676868] text-xs md:text-[14px] mt-2"
            >
          ...
          <div
            style={{ fontFamily: 'PovetaracSansBold' }}
            className={`text-[15px] md:text-xl ${isDarkMode?'text-white':'text-black'}`}
          >
          ...
          <div className="w-full py-4 md:py-6">
            <button
              ...
              className="flex-1 py-4 md:py-3 w-full md:max-w-[500px] cursor-pointer hover:scale-102 bg-[#00C2CC] flex items-center justify-center text-white text-[16px] lg:text-[18px] rounded-lg"
            >
